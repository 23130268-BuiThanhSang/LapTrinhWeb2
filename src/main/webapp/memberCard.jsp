...
<div class="accInfo">
    <div class="AccountLeft">
        ...
        <div class="AccountLeftOption">
            ...
            <div class="NameOptionBold">
                <i class="fa-solid fa-address-card"></i>
                <div class="NameOptionBoldText">Thẻ thành viên</div>
            </div>
            <div class="SignOut">
    ...
    <div class="memberCard">
        <div id="memberText">Thẻ thành viên SPGYM</div>
        <div id="memberGuide">Số thẻ là thông tin tài khoản được sử dụng để xác thực tài khoản của bạn</div>
        <div id="memberBenefic">Lợi ích thẻ thành viên:</div>
        <div id="beneficInfo">Nhận voucher freeship, giảm giá và nhiều ưu đãi thành viên khác.</div>
        <div class="CardInfo">
            <div class="logoCard">
                <img src="lgImg/logo.png" class="logoImg">
                <div id="logoText">SPGYM</div>
            </div>
            <div id="cardName">Bùi Thanh Sang</div>
            <img src="lgImg/seri.png" class="imgseri">
            <div id="seriText">2 943184 832910</div>
        </div>
    </div>
</div>
<footer class="footer">
