        ...
        <div class="FilterContent">
            ...
            <details class="FilterGroup">
                ...
                <div class="FilterBody SizeGrid">
                    <label class="SizeBox"><input type="checkbox"><span>41</span></label>
                    <label class="SizeBox"><input type="checkbox"><span>42</span></label>
                    <label class="SizeBox"><input type="checkbox"><span>43</span></label>
                    <label class="SizeBox"><input type="checkbox"><span>44</span></label>
                    <label class="SizeBox"><input type="checkbox"><span>45</span></label>
                </div>
            </details>
        </div>
    </aside>
