    ...
    <aside class="FilterSidebar">
        ...
        <div class="FilterContent">
            ...
            <details class="FilterGroup" open>
                ...
                <div class="FilterBody">
                    <label class="CustomCheckbox"><input type="checkbox"><span class="Checkmark"></span><span
                            class="LabelText">Thương hiệu 1</span></label>
                    <label class="CustomCheckbox"><input type="checkbox"><span class="Checkmark"></span><span
                            class="LabelText">Thương hiệu 2</span></label>
                    <label class="CustomCheckbox"><input type="checkbox"><span class="Checkmark"></span><span
                            class="LabelText">Thương hiệu 3</span></label>
                    <label class="CustomCheckbox"><input type="checkbox"><span class="Checkmark"></span><span
                            class="LabelText">Thương hiệu 4</span></label>
                    <label class="CustomCheckbox"><input type="checkbox"><span class="Checkmark"></span><span
                            class="LabelText">Thương hiệu 5</span></label>
                </div>
            </details>
            ...
            <details class="FilterGroup" open>
                ...
                <div class="FilterBody ColorGrid">
                    <label class="ColorSwatch" title="Đen"><input type="checkbox"><span class="SwatchDot"
                                                                                        style="background:#000"></span></label>
                    <label class="ColorSwatch" title="Trắng"><input type="checkbox"><span class="SwatchDot"
                                                                                          style="background:#fff; border:1px solid #ddd"></span></label>
                    <label class="ColorSwatch" title="Đỏ"><input type="checkbox"><span class="SwatchDot"
                                                                                       style="background:#d0021b"></span></label>
                    <label class="ColorSwatch" title="Xanh Dương"><input type="checkbox"><span class="SwatchDot"
                                                                                               style="background:#007bff"></span></label>
                    <label class="ColorSwatch" title="Vàng"><input type="checkbox"><span class="SwatchDot"
                                                                                         style="background:#f5a623"></span></label>
                    <label class="ColorSwatch" title="Xanh Lá"><input type="checkbox"><span class="SwatchDot"
                                                                                            style="background:#7ed321"></span></label>
                    <label class="ColorSwatch" title="Xám"><input type="checkbox"><span class="SwatchDot"
                                                                                        style="background:#9b9b9b"></span></label>
                </div>
            </details>
        </div>
    </aside>
